    ...
    buildRecenterControl: function() {
        ...
        const RecenterCtrl = L.Control.extend({
            ...
            onAdd: function() {
                ...
                c.innerHTML = '<a href="#" role="button" aria-label="Recenter to site" style="font-size:22px;line-height:36px;font-weight:bold;width:36px;height:36px;display:block;text-align:center;">&#8853;</a>';
